...
sealed interface QueryLevel {
  ...
  data class Top(val topLevelQuat: XRType): QueryLevel { override val isTop = true }

  /**
   * Top-level query that is not externally facing e.g. it's an unwrapped case
   * class AST
   */
  object TopUnwrapped: QueryLevel { override val isTop = true }

  /** Not a Top-level query */
  object Inner: QueryLevel { override val isTop = false }
}
