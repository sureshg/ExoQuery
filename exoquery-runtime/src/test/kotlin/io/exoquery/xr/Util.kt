...
fun XRType.Companion.LeafTuple(size: Int) =
  when(size) {
    ...
    4 -> XRType.Product("Tuple4", listOf("first" to XRType.Value, "second" to XRType.Value, "third" to XRType.Value, "fourth" to XRType.Value))
    5 -> XRType.Product("Tuple5", listOf("first" to XRType.Value, "second" to XRType.Value, "third" to XRType.Value, "fourth" to XRType.Value, "fifth" to XRType.Value))
    6 -> XRType.Product("Tuple6", listOf("first" to XRType.Value, "second" to XRType.Value, "third" to XRType.Value, "fourth" to XRType.Value, "fifth" to XRType.Value, "sixth" to XRType.Value))
    else -> throw IllegalArgumentException("Only up to 6 elements are supported for this operation")
  }
