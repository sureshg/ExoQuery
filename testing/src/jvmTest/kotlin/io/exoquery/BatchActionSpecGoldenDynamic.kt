...
object BatchActionSpecGoldenDynamic: GoldenQueryFile {
  override val queries = mapOf<String, GoldenResult>(
    ...
    "update/simple/SQL" to cr(
      "UPDATE Person SET name = {0:Refiner_STRING}, age = {1:Refiner_INT} WHERE Person WHERE id = {2:Refiner_INT}",
      "0" to "Refiner_STRING", "1" to "Refiner_INT", "2" to "Refiner_INT"
    ),
    "update/simple/Params1" to cr(
      "UPDATE Person SET name = {0:John-A}, age = {1:52} WHERE Person WHERE id = {2:1}",
      "0" to "John-A", "1" to "52", "2" to "1"
    ),
    "update/simple/Params2" to cr(
      "UPDATE Person SET name = {0:Jane-A}, age = {1:53} WHERE Person WHERE id = {2:2}",
      "0" to "Jane-A", "1" to "53", "2" to "2"
    ),
    "update/simple/Params3" to cr(
      "UPDATE Person SET name = {0:Jack-A}, age = {1:54} WHERE Person WHERE id = {2:3}",
    ...
    "update/simple - where clause/SQL" to cr(
      "UPDATE Person SET name = {0:Refiner_STRING}, age = {1:Refiner_INT} WHERE Person WHERE id = {2:Refiner_INT} AND age > 50",
      "0" to "Refiner_STRING", "1" to "Refiner_INT", "2" to "Refiner_INT"
    ),
    ...
    "update/simple with setParams and exclusion and returning param/SQL" to cr(
      "UPDATE Person SET name = {0:Refiner_STRING}, age = {1:Refiner_INT} WHERE Person WHERE id = {2:Refiner_INT} RETURNING id, {3:Refiner_STRING}",
