...
class NestedQuerySpec: FreeSpec({
  data class Grann(val s: String, val i: Int)
  data class Parr(val s: String, val i: Int)
  data class Chii(val s: String, val i: Int)
  data class Bayy(val s: String, val i: Int)
